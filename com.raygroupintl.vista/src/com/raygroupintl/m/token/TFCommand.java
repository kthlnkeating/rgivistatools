...
public class TFCommand extends TFSeq {
	...
	private static class TOCommandSpec extends TCommandSpec {
		...
		@Override
		protected ITokenFactory buildArgumentFactory(final MVersion version) {
			return MTFSupply.getInstance(version).cmdoargs; //TFCommaDelimitedList.getInstance(TFOpenArgument.getInstance(version)); 	
		}
	...
	private static class TRCommandSpec extends TCommandSpec {
		...
		@Override
		protected ITokenFactory buildArgumentFactory(final MVersion version) {
			return MTFSupply.getInstance(version).cmdrargs;  //TFCommaDelimitedList.getInstance(TFReadArgument.getInstance(version)); 	
		}
