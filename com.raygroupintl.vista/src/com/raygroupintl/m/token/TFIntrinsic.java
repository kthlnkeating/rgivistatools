...
public class TFIntrinsic extends TokenFactorySupply {		
	public static class TIntrinsicVariable extends MSequence {
		...
		@Override
		public Node getNode() {
			StringPieceImpl name = this.getSubNodeToken(0).getSubNodeToken(1).toValue();
	...
	private static class TIntrinsicFunction extends MSequence {
		...
		@Override
		public Node getNode() {
			StringPieceImpl name = ((MToken) this.get(0)).getSubNodeToken(0).getSubNodeToken(1).toValue();
