...
public class AssumedVariablesRecorder extends BlockRecorder<AssumedVariablesData> {
	private RepositoryInfo repositoryInfo;
	private boolean underDeviceParameter;
	
	public AssumedVariablesRecorder(RepositoryInfo ri) {
	...
	private void addOutput(Local local) {
		...
		AssumedVariablesData d = this.getCurrentBlockAttachedObject();
		if (d != null) {
			d.addLocal(i, local);	
		}
	}
	...
	@Override
	protected Block<AssumedVariablesData> getNewBlock(int index, EntryId entryId, HierarchicalMap<String, Block<AssumedVariablesData>> blocks, String[] params) {
		Block<AssumedVariablesData> result = new Block<AssumedVariablesData>(index, entryId, blocks, new AssumedVariablesData());
