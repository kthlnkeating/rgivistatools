...
public abstract class TFSerialROO extends TFSerial {
	...
	public static TFSerialROO getInstance(final ITokenFactory f0, final ITokenFactory f1, final ITokenFactory f2) {
		return new TFSerialROO() {			
			@Override
